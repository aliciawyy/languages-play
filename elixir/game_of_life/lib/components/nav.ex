defmodule GameOfLife.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", GameOfLife.Scene.Sensor},
           {"Primitives", GameOfLife.Scene.Primitives},
           {"Components", GameOfLife.Scene.Components},
           {"Transforms", GameOfLife.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
